...
def _build_mxfp_params(
    *,
    ...
    if quant_type not in [QuantType.MXFP8, QuantType.MXFP4, QuantType.W8A16FP8]:
        return None
...
def build_mlp_compute_input(
    *,
    ...
    return MoEMlpComputeInput(
        ...
        quant=fused_experts_input.quant,
        fusion=fused_experts_input.quant.quant_type in (QuantType.W8A8, QuantType.MXFP8, QuantType.W8A16FP8) and use_fusion_ops,
